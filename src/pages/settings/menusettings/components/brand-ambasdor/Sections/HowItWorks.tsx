...
import { AddhowItWork, DeletehowItWork, EdithowItWork } from "../PopUps";
...
export default function HowItWorksPage() {
  ...
  const filteredPartners = HowItWorks.filter((work) =>
