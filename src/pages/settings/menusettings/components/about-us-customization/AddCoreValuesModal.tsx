...
interface AddCoreValuesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

const AddCoreValuesModal: React.FC<AddCoreValuesModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Here you would typically call an API to add the core value
    console.log("Adding core value:", formData);
    onSuccess();
  };
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-5 flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-white">Add New Print Core Value</h2>
            <p className="text-blue-100 mt-1">Define your organization's core printing values</p>
          </div>
          <button 
            onClick={onClose}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-800"
                placeholder="Describe this core value in detail..."
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-gray-500 mt-1">Recommended size: 500x500px (1:1 ratio)</p>
            </div>
          </div>
...
export default AddCoreValuesModal;