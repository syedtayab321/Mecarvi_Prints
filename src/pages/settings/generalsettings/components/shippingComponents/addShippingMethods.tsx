...
const AddShippingMethodModal: React.FC<AddShippingMethodModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Here you would typically call an API to add the shipping method
    console.log("Adding shipping method:", formData);
    onSuccess();
  };
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-100">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-5 flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-100 mt-1">Enter details for your new shipping option</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-800"
                placeholder="e.g. Tracking, Insurance"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-800"
              placeholder="Provide any additional details about this shipping method..."
            />
          </div>
